...
public class IOTBridgeQualitySpout implements IRichSpout {

    private SpoutOutputCollector spoutOutputCollector;

    private static final Logger LOG = LoggerFactory.getLogger(IOTBridgeQualitySpout.class);
    ...
    public IOTBridgeQualitySpout(Properties properties) {
