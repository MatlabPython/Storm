 ...
 * Written on 17/8/31.
 */
public class IOTGasSpout implements IRichSpout {

  private SpoutOutputCollector spoutOutputCollector;

  private static final Logger LOG = LoggerFactory.getLogger(com.gsafety.gas.IOTGasSpout.class);
  ...
  public IOTGasSpout(Properties properties) {
